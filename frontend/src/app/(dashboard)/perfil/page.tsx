...
const labelStyle: React.CSSProperties = { display:'block', fontSize:'0.78rem', fontWeight:600, color:'rgba(255,255,255,0.45)', marginBottom:'5px', textTransform:'uppercase', letterSpacing:'0.04em' };
...
const btnSecondary: React.CSSProperties = { background:'rgba(255,255,255,0.06)', color:'rgba(255,255,255,0.7)', border:'1px solid rgba(255,255,255,0.1)', padding:'0.8rem 1.6rem', borderRadius:'12px', fontWeight:600, cursor:'pointer', fontSize:'0.9rem' };
            ...
            {([
              ...
              <div key={label}>
                ...
                <div style={{ position:'relative' }}>
                  ...
                  <button type="button" onClick={()=>setVer((p:boolean)=>!p)} style={{ position:'absolute', right:'0.9rem', top:'50%', transform:'translateY(-50%)', background:'transparent', border:'none', color:'rgba(255,255,255,0.4)', cursor:'pointer' }}>
