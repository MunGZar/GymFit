 ...
 * + botón "Agregar Participante" que abre ModalParticipante
 */
...
const ModalParticipante = dynamic(() => import('./ModalParticipante'), { ssr: false });
...
const LoginForm = () => {
  ...
  return (
    <>
      ...
      {showModal && <ModalParticipante onClose={() => setShowModal(false)} />}
    </>
  );
};
